...
final readonly class GetStatusZipRequest implements DianSoapBody
{
    ...
    {
        if (trim($trackId) === '') {
            throw new InvalidArgumentException('GetStatusZip trackId cannot be empty.');
        }
    }

    public function operation(): DianSoapOperation
    {
        return DianSoapOperation::GetStatusZip;
    }
    ...
    public function appendTo(DOMElement $soapBody): void
    {
        ...
        $operation = $document->createElementNS(self::NS_WCF, 'wcf:GetStatusZip');
