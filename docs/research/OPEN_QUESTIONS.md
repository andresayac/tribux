...
| Q-003 | ¿Cuál es el perfil completo XAdES? Un error causa rechazo. | Anexo 1.9, política v2 y ejemplos de caja | **Hipótesis:** un firmador dedicado podrá emitir XAdES-EPES sin acoplar dominio. | Fixture firmado y aceptado; no modificar XML tras canonicalizar. | Parcial |
