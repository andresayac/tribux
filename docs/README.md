...
- `PROJECT_VISION.md` — problema, alcance y filosofía.
- `AI_AGENT_BRIEF.md` — handoff para agentes IA.
- `WORK_PLAN.md` — plan por fases.
...
- `DEPLOYMENT.md` — niveles de despliegue.
- `MAINTENANCE.md` — proceso ante cambios DIAN.
- `SOURCE_POLICY.md` — política de fuentes.
- `research/OPEN_QUESTIONS.md` — dudas no resueltas.
